...
LANGUAGES.EN = {
    ...
    text: {
        ...
        'fish-name': "Spare parts repair",
        'fish-costName': toTextStyle('Spare parts repair','fish'),

        'prestige-name': "The most common types of bread are:",
        'prestige-costName': toTextStyle('The most','prestige') + "common types of bread are:",
        ...
        'curr-top-0-req': x => `Reach <b>${format(x)}</b> total ${toTextStyle('Spare parts repair','fish')}`, 
        ...
        'curr-top-2-req': x => `Reach <b>${format(x)}</b> ${toTextStyle('Spare parts repair','fish')}`, 
        'curr-top-2-reset': (x,next) => `Evolve your ${toTextStyle('Sharks','shark')} into <b>${format(x,0)}</b> ${toTextStyle('Humanoid','humanoid')} Sharks (Next at <b>${format(next)}</b> ${toTextStyle('Spare parts repair','fish')})`,

        'curr-top-3-req': x => `Reach <b>${format(x)}</b> ${toTextStyle('Spare parts repair','fish')} & <b>8</b> ${toTextStyle('Black Holes','black-hole')}`, 
        ...
        'curr-top-6-reset': (x,next) => `Hadronize for <b>${format(x,0)}</b> ${toTextStyle('Fundamental Particles','hadron')} (Next at <b>${format(next)}</b> ${toTextStyle('Spare parts repair','fish')})`,
        ...
        'fish-div': `Your ${toTextStyle('Shark','shark')} has eaten <h2>${toTextStyle('0','fish','fish-amount')}</h2> <span id="fish-gain"></span> spare parts repair.`,
